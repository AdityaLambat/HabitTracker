...
const DayView = ({ day }) => {
  ...
  const markToDone = () => {
    if (day.id > todayDay) {
      alert("You Cannot Update Next Days Status")
      return;
    }
  ...
  return (
    <div className="day-container">
      ...
      <i className={day.isDone === true ? "fa-solid fa-circle-check circle-icon activeyes" : "fa-solid fa-circle-check circle-icon"} onClick={markToDone}></i>
      <i className={day.isDone === false ? "fa-solid fa-circle-xmark circle-icon activeno" : "fa-solid fa-circle-xmark circle-icon"} onClick={markToUnDone}></i>
      <i className={day.isDone === "" ? "fa-solid fa-circle-minus circle-icon activenone" : "fa-solid fa-circle-minus circle-icon"} onClick={markToNone}></i>
    </div>
  );
};
